...
Cufon.replace('#header .row-2 ul li, h2, h3, h4, h5', { fontFamily: 'Gill Sans', hover:true });
Cufon.replace('.movie-detail p' , { fontFamily: 'Gill Sans', hover:true, color: '-linear-gradient(#bfbfbf, #919191)'});